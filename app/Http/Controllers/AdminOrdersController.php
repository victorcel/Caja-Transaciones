<?php namespace App\Http\Controllers;
	...
	class AdminOrdersController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
            ...
            $this->form[] = ['label'=>'Cliente','name'=>'cliente_id','type'=>'datamodal','datamodal_table'=>'clientes','datamodal_where'=>'','datamodal_columns'=>'first_name,last_name,username','datamodal_select_to'=>'id:cliente_id'];
	        ...
	        */
            ...
            $this->index_button[] = ['label'=>'Crear Tarjeta','url'=>"tarjetas/add","icon"=>"fa fa-credit-card"];
            $this->index_button[] = ['label'=>'Crear Usuario','url'=>"clientes/add","icon"=>"fa fa-users"];
