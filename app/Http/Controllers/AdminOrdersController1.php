<?php namespace App\Http\Controllers;
	...
	class AdminOrdersController1 extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
            ...
            $this->form[] = ['label'=>'Cliente','name'=>'cliente_id','type'=>'datamodal','datamodal_table'=>'clientes','datamodal_where'=>'','datamodal_columns'=>'id,name,username','datamodal_select_to'=>'id:cliente_id'];
			...
			# OLD START FORM
			//$this->form = [];
			//$this->form[] = ['label'=>'User','name'=>'user_id','type'=>'select2','validation'=>'required|integer|min:0','width'=>'col-sm-10','datatable'=>'cms_users,id','datatable_format'=>'id,\' | \',name'];
			//$this->form[] = ['label'=>'Cliente','name'=>'cliente_id','type'=>'select2','validation'=>'required|integer|min:0','width'=>'col-sm-10','datatable'=>'clientes,id','datatable_format'=>'username\' | \',name,\' | \',last_name'];
			//$this->form[] = ['label'=>'Tarjeta','name'=>'tarjeta_id','type'=>'select2','validation'=>'required|integer|min:0','width'=>'col-sm-10','datatable'=>'tarjetas,id'];
			//$this->form[] = ['label'=>'Total','name'=>'total','type'=>'number','validation'=>'required|integer|min:0','width'=>'col-sm-10'];
			# OLD END FORM
